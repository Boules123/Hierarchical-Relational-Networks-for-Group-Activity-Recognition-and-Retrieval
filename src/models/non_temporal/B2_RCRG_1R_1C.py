...
if __name__ == "__main__":
    cfg = get_config("configs/B2_RCRG_1R_1C.yml")
    train(cfg)
    test(cfg)


# Accuracy: 86.06%  |  F1: 0.8599

#               precision    recall  f1-score   support

#        r_set       0.78      0.88      0.83      1728
#      r_spike       0.88      0.90      0.89      1557
#       r-pass       0.90      0.71      0.80      1890
#   r_winpoint       0.97      0.82      0.89       783
#   l_winpoint       0.86      0.93      0.89       918
#       l-pass       0.80      0.91      0.85      2034
#      l-spike       0.89      0.92      0.91      1611
#        l_set       0.91      0.83      0.87      1512

#     accuracy                           0.86     12033
#    macro avg       0.87      0.86      0.87     12033
# weighted avg       0.87      0.86      0.86     12033
